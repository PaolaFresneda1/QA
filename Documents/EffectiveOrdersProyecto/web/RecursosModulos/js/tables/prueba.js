...
})(function(h, D, I, k)
{
    ...
    r.extend =
        function(a, b, c)
        {
            if (c.length && b && (b instanceof r || b.__dt_wrapper))
            {
                ...
                d = 0;
                for (e = c.length; d < e; d++) f = c[d], b[f.name] = "function" === typeof f.val ? g(a, f.val, f) : h.isPlainObject(f.val) ?
                {} : f.val, b[f.name].__dt_wrapper = !0, r.extend(a, b[f.name], f.propExt)
            }
        };
        ...
        b, c, d)
    {
        ...
        {
            e.oFeatures.bFilter && fa(e, h.extend(
            {}, e.oPreviousSearch,
            {
                sSearch: a + "",
                bRegex: null === b ? !1 : b,
