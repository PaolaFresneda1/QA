 ...
 * @author Julian
 */
@WebServlet(name = "controladorPrecarga", urlPatterns = {"/controladorPrecarga"})
public class ControladorPrecarga extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("/faces/Proveedor/precarga.xhtml").forward(request, response);
        }
    }
