...
@NamedQueries({
    ...
    @NamedQuery(name = "Auditoria.findByComentario", query = "SELECT a FROM Auditoria a WHERE a.comentario = :comentario"),
...
public class Auditoria implements Serializable {
    ...
    public String toString() {
        return "com.Entity.Auditoria[ idAuditoria=" + idAuditoria + " ]";
    }
